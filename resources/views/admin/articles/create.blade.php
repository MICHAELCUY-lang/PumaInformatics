<x-admin-layout>
    <div class="mb-12">
        ...
        <h1 class="text-3xl font-serif text-gray-900 tracking-tight">Compose Article</h1>
    </div>

    <form method="POST" action="{{ route('admin.articles.store') }}" enctype="multipart/form-data" class="max-w-4xl">
        @csrf
        
        <div class="space-y-12">
            <!-- Title -->
            <div>
                <input type="text" name="title" placeholder="Article Title" class="w-full text-4xl font-serif text-gray-900 border-0 border-b border-gray-200 focus:border-museum-black focus:ring-0 px-0 py-4 placeholder-gray-300 bg-transparent transition-colors" required value="{{ old('title') }}">
            ...
            <div class="flex flex-wrap gap-8 items-center border-b border-gray-100 pb-8">
                ...
                <div>
                    ...
                    <label class="flex items-center space-x-2 cursor-pointer">
                        ...
                        <input type="checkbox" name="is_featured" value="1" class="rounded border-gray-300 text-museum-black focus:ring-museum-black" {{ old('is_featured') ? 'checked' : '' }}>
            ...
            <div>
                ...
                <textarea name="excerpt" rows="2" class="w-full border-gray-200 focus:border-museum-black focus:ring-0 rounded-none p-4 text-sm font-sans" placeholder="A brief summary of the article...">{{ old('excerpt') }}</textarea>
