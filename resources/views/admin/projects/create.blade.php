<x-admin-layout>
    <div class="mb-12">
        ...
        <h1 class="text-3xl font-serif text-gray-900 tracking-tight">Archive Project</h1>
    </div>

    <form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data" class="max-w-5xl">
        @csrf
        
        <div class="space-y-12">
            <!-- Title -->
            <div>
                <input type="text" name="title" placeholder="Project Title" class="w-full text-5xl font-serif text-gray-900 border-0 border-b border-gray-200 focus:border-museum-black focus:ring-0 px-0 py-4 placeholder-gray-300 bg-transparent transition-colors" required value="{{ old('title') }}">
